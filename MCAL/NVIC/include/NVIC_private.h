...
typedef struct
{
    ...
    volatile u32 RESERVED0[24];  // Reserved space
    ...
    volatile u32 RESERVED4[56];  // Reserved space
    volatile u8 IPR[240];        // Interrupt Priority Registers (Offset: 0x300 - 0x3EF)
    volatile u32 RESERVED5[644]; // Reserved space
